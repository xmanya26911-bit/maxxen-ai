...
export async function sendOtpMail(to: string, code: string) {
  ...
  await mailer().sendMail({
    ...
    html: "<div style=\"font-family:sans-serif;background:#0a0a16;padding:32px;color:#fff\">" + "<h1>Maxxen AI</h1><p>Your 6-digit code:</p>" + "<div style=\"font-size:36px;letter-spacing:8px;font-weight:800\">" + code + "</div>" + "<p style=\"opacity:.6\">Expires in 10 minutes. Never share this code.</p></div>",
  });
}