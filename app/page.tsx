...
const FAQS = [
  { q: "Is Maxxen AI free?", a: "Yes. You bring your own API key, so you only ever pay your AI provider (free tiers work fine). Hosting is your own Vercel, storage is your own GitHub." },
  { q: "Where does my data go?", a: "Into a private <code>maxxen-data</code> repository inside YOUR GitHub account. The developer cannot see it." },
  { q: "Which AI models work?", a: "Anything OpenAI-compatible plus Gemini: GPT-4o-mini, Gemini Flash, and custom base URLs like OpenRouter or Groq." },
  { q: "How do plugins work?", a: "Paste YOUR Composio API key on the Plugins tab, connect toolkits at app.composio.dev, and the agent can act on them." },
  { q: "Why did my OTP say incorrect?", a: "Each new request replaces the previous code — always use the code from your NEWEST email, within 10 minutes." },
];
  ...
  return (
    <div className="lp">
      <nav className="lp-nav">
        ...
        <div className="lp-links"><a href="#product">Product</a><a href="#how">How it works</a><a href="#security">Security</a><a href="#faq">FAQ</a></div>
        <div className="lp-nav-right"><a href="/login" className="lp-login">Log in</a><a href="/chat" className="lp-cta">Launch app ↗</a></div>
      </nav>
      <header className="lp-hero">
        <span className="lp-orb lp-o1" aria-hidden="true" />
        <span className="lp-orb lp-o2" aria-hidden="true" />
        <span className="lp-orb lp-o3" aria-hidden="true" />
        ...
        <p className="lp-sub">Maxxen is a multipurpose agentic AI that <b>designs, builds and deploys</b> websites, apps and dashboards with you — running on <b>your</b> API keys, <b>your</b> GitHub and <b>your</b> Vercel.</p>
        <div className="lp-hero-cta"><a href="/login" className="lp-cta">Start building — free ↗</a><a href="#how" className="lp-cta ghost">See how it works</a></div>
      ...
      <div className="lp-marquee" aria-hidden="true"><div className="lp-marquee-track">{["WEBSITES", "APPS", "DASHBOARDS", "LANDING PAGES", "AGENTS", "AUTOMATIONS", "PROTOTYPES", "DEPLOYS"].map((w, i) => <span key={i}>{w} <i>✦</i></span>)}</div></div>
      <section className="lp-section" id="product">
        ...
        <div className="lp-grid">{FEATURES.map((f) => (<div className="lp-card lp-reveal" key={f.t}><div className="glyph">{f.g}</div><h3>{f.t}</h3><p>{f.d}</p><p style={{ marginTop: 14 }} dangerouslySetInnerHTML={{ __html: f.c }} /></div>))}</div>
      </section>
      <section className="lp-section" id="how" style={{ paddingTop: 0 }}>
        ...
        <div className="lp-steps" style={{ marginTop: 50 }}>
          <div className="lp-step lp-reveal"><b className="num">1</b><h3>Verify your email</h3><p>Get a 6-digit code at any address. It self-destructs in <code>10 minutes</code>.</p></div>
          ...
          <div className="lp-step lp-reveal"><b className="num">3</b><h3>Build and deploy</h3><p>Chat in <code>/chat</code>, preview live builds, save to <code>your GitHub</code>, ship to <code>your Vercel</code>.</p></div>
        </div>
      </section>
      <div className="lp-band" id="security">
        <div className="lp-band-inner">
          <div>
            ...
            <p className="lp-lead lp-reveal" style={{ marginBottom: 0 }}>There is no Maxxen database. Your secrets live in your browser; your work lives in your GitHub.</p>
            <div className="lp-checks">
              ...
              <div className="lp-check lp-reveal"><i>✓</i><div><b>OTPs evaporate in 10 minutes</b><span>Signed tickets carry their own expiry.</span></div></div>
            </div>
          </div>
      ...
      <section className="lp-section">
        ...
        <div className="lp-teaser lp-reveal">
          ...
          <div className="lp-teaser-body">
            <div className="lp-teaser-prompt"><small>YOU ASKED</small><p>“Build me a premium landing page — <em>editorial type,</em> dark glass, live preview.”</p><div style={{ marginTop: 26 }}><a href="/chat" className="lp-cta">Try it live ↗</a></div></div>
            <div className="lp-teaser-shot"><b>MAXXEN</b><strong>BUILT<br />FOR THE<br /><i>DIFFERENT.</i></strong><span>● Live preview · single-file HTML</span></div>
          </div>
        </div>
      </section>
      <section className="lp-section" id="faq" style={{ paddingTop: 0 }}>
        ...
        <div className="lp-faq">{FAQS.map((f) => (<details key={f.q} className="lp-reveal"><summary>{f.q}<span>+</span></summary><p dangerouslySetInnerHTML={{ __html: f.a }} /></details>))}</div>
      </section>
      ...
      <footer className="lp-footer">
        ...
        <nav><a href="/chat">Chat</a><a href="/login">Login</a><a href="/settings">Settings</a><a href="https://github.com/xmanya26911-bit/Maxxen" target="_blank" rel="noreferrer">GitHub</a></nav>
